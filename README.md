...
This `python` script will clean your Desktop and move it's content to a specified folder.
Imagine `First` folder is your `Desktop` and `Second` folder is your `specified path` to put your Desktop's junk files there. See the Screenshots for more detail.
